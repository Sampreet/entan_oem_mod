...
looper = wrap_looper(SystemClass=OEM_20, params=params, func=func_mdy_min, looper='XLooper', file_path_prefix='data/v2.0-qom-v0.8.5/3c_Sq_0')
Sq_0 = looper.results['V']

# looper with laser, voltage and frequency modulation
params['system']['A_vs'] = [50.0, 50.0, 50.0]
params['system']['theta'] = 0.5
looper = wrap_looper(SystemClass=OEM_20, params=params, func=func_mdy_min, looper='XLooper', file_path_prefix='data/v2.0-qom-v0.8.5/3c_Sq_1')
...
params['system']['A_vs'] = [50.0, 0.0, 0.0]
params['system']['theta'] = 0.5
looper = wrap_looper(SystemClass=OEM_20, params=params, func=func_mdy_max, looper='XLooper', file_path_prefix='data/v2.0-qom-v0.8.5/3c_En_0')
En_0 = looper.results['V']

# looper with laser, voltage and frequency modulation
params['system']['A_vs'] = [50.0, 50.0, 50.0]
params['system']['theta'] = 0.5
looper = wrap_looper(SystemClass=OEM_20, params=params, func=func_mdy_max, looper='XLooper', file_path_prefix='data/v2.0-qom-v0.8.5/3c_En_1')
