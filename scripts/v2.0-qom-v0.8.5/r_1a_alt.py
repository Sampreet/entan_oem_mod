...
params = {
    ...
    'plotter': {
        ...
        'x_label': '$n_{th_{b}}$',
        'x_label_pad': 20,
        'x_tick_labels': ['$10^{' + str(i) + '}$' for i in range(5)],
        'x_tick_pad': 16,
        'x_ticks': [10**(i) for i in range(5)],
        'x_ticks_minor': [(i % 10 + 1) * 10**int(i / 10) for i in range(41)],
        'x_scale': 'log',
        'y_colors': ['b', 'b'],
        'y_sizes': [2, 2],
        'y_styles': [':', '-'],
...
looper = wrap_looper(SystemClass=OEM_20, params=params, func=func_mdy_max, looper='XLooper', file_path_prefix='data/v2.0-qom-v0.8.5/r_1a_alt_En_0')
X = looper.axes['X']['val']
...
looper = wrap_looper(SystemClass=OEM_20, params=params, func=func_mdy_max, looper='XLooper', file_path_prefix='data/v2.0-qom-v0.8.5/r_1a_alt_En_1')
