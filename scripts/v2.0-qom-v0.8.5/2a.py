...
# color patches
ax.axvspan(990.70, 991.65, color=_colors[8], alpha=0.25)
ax.axvspan(993.85, 994.80, color=_colors[8], alpha=0.25)
ax.axvspan(997.00, 997.95, color=_colors[8], alpha=0.25)
ax.axvspan(990.05, 990.95, color=_colors[2], alpha=0.25)
ax.axvspan(993.20, 994.15, color=_colors[2], alpha=0.25)
ax.axvspan(996.35, 997.30, color=_colors[2], alpha=0.25)
ax.axvspan(999.50, 1000.0, color=_colors[2], alpha=0.25)
# show
plotter.show(True)