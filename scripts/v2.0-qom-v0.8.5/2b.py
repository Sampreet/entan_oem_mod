...
# color patches
ax.axvspan(990.80, 991.75, color=_colors[8], alpha=0.25)
ax.axvspan(993.95, 994.90, color=_colors[8], alpha=0.25)
ax.axvspan(997.10, 998.05, color=_colors[8], alpha=0.25)
ax.axvspan(990.15, 991.05, color=_colors[2], alpha=0.25)
ax.axvspan(993.30, 994.25, color=_colors[2], alpha=0.25)
ax.axvspan(996.45, 997.40, color=_colors[2], alpha=0.25)
ax.axvspan(999.60, 1000.0, color=_colors[2], alpha=0.25)
# show
plotter.show(True)