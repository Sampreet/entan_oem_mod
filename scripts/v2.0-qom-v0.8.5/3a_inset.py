...
params = {
    ...
    'plotter': {
        'type': 'lines',
        'x_label': '',
        'x_ticks': [1.995, 2.0, 2.005],
        'x_ticks_minor': [1.995 + i * 0.00125 for i in range(9)],
        'y_colors': ['k'] + ['r'] * 2 + ['b'] * 2,
        'y_sizes': [1] + [2] * 4,
        'y_styles': ['--'] + ['-.', '-'] * 2,
        'v_label': '',
        'v_label_color': 'r',
        'v_limits': [0.35, 0.625],
        'v_tick_labels': [0.4, '', 0.6],
        'v_tick_position': 'left-in',
        'v_ticks': [0.4, 0.5, 0.6],
        'v_ticks_minor': [0.35 + i * 0.025 for i in range(12)],
        'v_twin_label': '',
        'v_twin_label_color': 'b',
        'v_twin_limits': [0.075, 0.2125],
        'v_twin_tick_labels': [0.1, '', 0.2],
        'v_twin_tick_position': 'right-in',
        'v_twin_ticks': [0.1, 0.15, 0.2],
        'v_twin_ticks_minor': [0.075 + i * 0.0125 for i in range(12)],
        'label_font_size': 48,
        'tick_font_size': 40,
        'width': 4.8,
        'height': 4.0,
