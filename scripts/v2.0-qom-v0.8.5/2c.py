...
# color patches
ax.axvspan(990.60, 991.65, color=_colors[8], alpha=0.25)
ax.axvspan(993.75, 994.80, color=_colors[8], alpha=0.25)
ax.axvspan(996.90, 997.95, color=_colors[8], alpha=0.25)
ax.axvspan(991.85, 992.95, color=_colors[2], alpha=0.25)
ax.axvspan(995.00, 996.10, color=_colors[2], alpha=0.25)
ax.axvspan(998.15, 999.25, color=_colors[2], alpha=0.25)
# show
plotter.show(True)