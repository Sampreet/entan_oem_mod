...
params = {
    ...
    'plotter': {
        ...
        'x_ticks_minor': [1.8 + i * 0.02 for i in range(21)],
...
looper = wrap_looper(SystemClass=OEM_20, params=params, func=func_mdy_min, looper='XLooper', file_path_prefix='data/v3.0-qom-v0.8.6/r_3a_Sq_0_' + str(t_max) + '_' + str(cyc))
Sq_0 = looper.results['V']

# looper with laser, voltage and frequency modulation
params['system']['A_vs'] = [50.0, 50.0, 50.0]
params['system']['theta'] = 0.5
looper = wrap_looper(SystemClass=OEM_20, params=params, func=func_mdy_min, looper='XLooper', file_path_prefix='data/v3.0-qom-v0.8.6/r_3a_Sq_1_' + str(t_max) + '_' + str(cyc))
...
params['system']['A_vs'] = [50.0, 50.0, 50.0]
params['system']['theta'] = 0.0
looper = wrap_looper(SystemClass=OEM_20, params=params, func=func_mdy_max, looper='XLooper', file_path_prefix='data/v3.0-qom-v0.8.6/r_3a_En_0_' + str(t_max) + '_' + str(cyc))
En_0 = looper.results['V']

# looper with laser, voltage and frequency modulation
params['system']['A_vs'] = [50.0, 50.0, 50.0]
params['system']['theta'] = 0.5
looper = wrap_looper(SystemClass=OEM_20, params=params, func=func_mdy_max, looper='XLooper', file_path_prefix='data/v3.0-qom-v0.8.6/r_3a_En_1_' + str(t_max) + '_' + str(cyc))
